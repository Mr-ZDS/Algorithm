...
# 加载图片
rabbit_img = pygame.image.load("E:/项目/python/game_img/rabbit.png")
# 再加一些风景~
grass_img = pygame.image.load("E:/项目/python/game_img/grass.png")
castle_img = pygame.image.load("E:/项目/python/game_img/castle.png")
# 加载箭头
arrow_img = pygame.image.load('E:/项目/python/game_img/arrow.png')
# 加载獾
badguy_img1 = pygame.image.load("E:/项目/python/game_img/wolf.png")
badguy_img = badguy_img1
# 加载城堡健康值图片
healthbar_img = pygame.image.load("E:/项目/python/game_img/healthbar.png")
health_img = pygame.image.load("E:/项目/python/game_img/health.png")
# 加载胜利与失败图片
gameover_img = pygame.image.load("E:/项目/python/game_img/gameover.png")
youwin_img = pygame.image.load("E:/项目/python/game_img/youwin.png")
# 加载声音文件并配置音量
hit = pygame.mixer.Sound("E:/项目/python/game_img/explode.wav")
enemy = pygame.mixer.Sound("E:/项目/python/game_img/enemy.wav")
shoot = pygame.mixer.Sound("E:/项目/python/game_img/shoot.wav")
hit.set_volume(0.05)
enemy.set_volume(0.05)
shoot.set_volume(0.05)
# 加载游戏的背景音乐并让背景音乐一直不停的播放。
pygame.mixer.music.load('E:/项目/python/game_img/back.mp3')
pygame.mixer.music.play(-1, 0.0)
pygame.mixer.music.set_volume(0.25)

# 不停地循环执行接下来的部分
running = True              # running变量会跟踪游戏是否结束
exitcode = False            # exitcode变量会跟踪玩家是否胜利
while running:
	# 在给屏幕画任何东西之前用黑色进行填充
	screen.fill(0)
	for x in range(width//grass_img.get_width()+1):          # 添加的风景也需要画在屏幕上# 添加的风景也需要画在屏幕上
	...
	# 更新并且显示这些坏蛋
	# 检查badtimer是否为0，如果为0，创建一只狼然后重新设置badtimer。
	# 第一个循环更新狼的x坐标，检查狼是否超出屏幕范围，如果超出范围，将狼删掉。
	# 第二个循环是来画出所有的狼。
	if badtimer == 0:
